...
<!-- Кнопка отправки -->
<button class="btn btn-primary" onclick="submitRating()" data-id="{{ $trackId }}">Оценить</button>
<button class="btn btn-primary" onclick="showReviewForm({{ $trackId }})">Оcтавить рецензию</button>